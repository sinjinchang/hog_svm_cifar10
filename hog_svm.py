...
# 训练集图片的位置
train_image_path = 'image127'
# 测试集图片的位置
test_image_path = 'image129'

# 训练集标签的位置
train_label_path = os.path.join('image127','train_labels.txt')
# 测试集标签的位置
test_label_path = os.path.join('image129','test_labels.txt')
